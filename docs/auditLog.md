...
- ใครเปลี่ยนสถานะออเดอร์ #ORD-20260902-A1B2C3 เป็น "cancelled" เมื่อวานนี้
...
|---|---|---|
| ลูกค้าสั่งซื้อ | `สั่งซื้อ ORD-...` | `Order` |
| แอดมินสั่งแทนลูกค้า | `สร้างออเดอร์แทนลูกค้า POS-...` (หรือ ORD- ถ้า channel=online) | `Order` |
