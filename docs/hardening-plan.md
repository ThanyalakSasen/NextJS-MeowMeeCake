...
**ก่อนขึ้น production อย่างน้อยต้อง:** 3.2 · 3.10 · 3.9 ✅ เสร็จแล้ว (+ §1 blockers ที่ยังค้าง: seed, sync-indexes, secret)
**ทำได้เรื่อย ๆ หลัง launch:** 3.8 · 3.12 · 3.13–3.16 (3.7 ✅ เสร็จใน D3)
